...
//! farz kisim alttaki haldeki gibi
...
const veriGetir=()=>{
    fetch("https://api.github.com/users").then((res)=>{
        if (res.ok==false) {
            ...
            console.log("hata");//throw ile kendi error umuzu fırlatırsak, hata olduğunda kod burada durur.
            // hatta o yüzden if ten sonra else yazmaya gerek yok
        }
        return res.json()
