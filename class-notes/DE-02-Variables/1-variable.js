...
// yas=30;
// const ile tanimlanan degisken degistirilemez, console da hata gozukur

// const pi;
// const degiskenine baskangic atamasi yaomak zorunlu
...
//! var keyword u kullanilinca block icerisinde ve disarisinda erisilebilir.
//! Block icinde tanimlanan degiskene disardan da erisebiliriz.
console.log("*********************************");
...

{
    ...
    let second="halit";
    console.log(second);
    // suslu icinde yazdirir ancak disarida goremez
}
// console.log(second); blocktaki elemana disaridan erisilemez(const ve let icin)
console.log(first);


console.log("*********************************");
//! LET TEKI AYNI ISLEMLERI CONST ICIN DE YAPiYORUZ
